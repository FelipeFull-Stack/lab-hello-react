        ...
        <>
            <div className={style.divPai}>
                ...
                <div className={style.divIntro}>
                    <h1 className={style.titulo}>Say hello to ReactJs</h1>
                    <p className={style.paragrafo}>You will learn how to use<br></br>the most popular frontend library,<br></br>and become a super Ninja developer.</p>
